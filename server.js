...
app.get("/cached/scripts/redux.js", (req, res) => {
  res.sendFile(
    path.join(__dirname, "node_modules", "redux", "dist", "redux.js"),
  );
});
app.get("/cached/scripts/sw-toolbox.js", (req, res) => {
  res.sendFile(
    path.join(__dirname, "node_modules", "sw-toolbox", "sw-toolbox.js"),
  );
});
app.get("/cached/scripts/moment.js", (req, res) => {
  res.sendFile(
    path.join(__dirname, "node_modules", "moment", "min", "moment.min.js"),
  );
});
